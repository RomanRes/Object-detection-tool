...
def do_nms(
    ...
    for c in exist_classes:
        ...
        while sort_indexes.size != 0:
            ...
            xx1 = np.maximum(
                selected_boxes[current_box_index][0], selected_boxes[sort_indexes, 0]
            )
            yy1 = np.maximum(
                selected_boxes[current_box_index][1], selected_boxes[sort_indexes, 1]
            )
            xx2 = np.minimum(
                selected_boxes[current_box_index][2], selected_boxes[sort_indexes, 2]
            )
            yy2 = np.minimum(
                selected_boxes[current_box_index][3], selected_boxes[sort_indexes, 3]
            )
